...
class ConsoleView(View):
    ...
    def display(self, record):
        formatted_data = {}
        formatted_data['name'] = record['name']
        formatted_data['phones'] = ", ".join(record['phones'])
        formatted_data['birthday'] = record['birthday'].strftime("%d/%m/%Y")
        formatted_data['email'] = record['email']
        formatted_data['status'] = record['status']
        formatted_data['note'] = record['note']

        self.output_formatter.format_output(formatted_data)
